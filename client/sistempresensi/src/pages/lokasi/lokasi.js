...
class LokasiPage extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loading: true,
    ...
    async getDataLokasi() {
        ...
        axios.get("lokasi", {
            ...
            this.setState({ dataLokasi: response.data.data })
        }).catch((error) => {
            ...
            <>
                ...
                <header className="bg-white shadow">
                    <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                        <h1 className="text-3xl font-bold text-gray-900">Data Lokasi</h1>
                    </div>
                </header>
                <main>
